...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etEmail = findViewById(R.id.editText_LoginName);
        etPassword = findViewById(R.id.editText_LoginPassword);

        Button reg_btn = (Button) findViewById(R.id.button_register);

        reg_btn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                startActivity(new Intent(MainActivity.this, reg_page.class));
            }
        });
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://cb-in.stackstaging.com/login.php");
